...
const require_context = require("../context-DwJ7q8OT.cjs");
	...
	mount(el) {
		...
		const dispose = require_context.render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = require_context.lazy(() => Promise.resolve().then(() => require("../FloatingTanStackRouterDevtools-CQ2gLjaA.cjs")));
	...
	mount(el) {
		...
		const dispose = require_context.render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = require_context.lazy(() => Promise.resolve().then(() => require("../BaseTanStackRouterDevtoolsPanel-BpdaShOz.cjs")));
